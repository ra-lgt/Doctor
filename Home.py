...
def mail_to_doctor(data,templates,subject):
    try:
        ...
        message["from"]="zensyncsolutions@gmail.com"
        message["to"]=email

        html_mail=MIMEText(output_html,'html')
        message.attach(html_mail)
        server=smtplib.SMTP_SSL("smtp.gmail.com",465)
        server.login("zensyncsolutions@gmail.com","bdqyeshysfiuzksg")
        server.sendmail("zensyncsolutions@gmail.com",email,message.as_string())
        return True
